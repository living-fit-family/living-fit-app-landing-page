  ...
  return (
    <section id="cta" className="relative z-10 pt-[110px]">
        <div className="container max-w-[1390px]">
          <div
            className="rounded-2xl bg-white px-10 pt-14 shadow-card dark:bg-dark dark:shadow-card-dark sm:px-20 lg:px-12 lg:pt-20 xl:px-20"
          >
            <div className="-mx-4 flex flex-wrap">
              <div className="w-full self-center px-4 lg:w-1/2">
                ...
                >
                  <h2
                    className="mb-4 text-3xl font-bold text-black dark:text-white sm:text-4xl md:text-[38px] md:leading-tight"
                  >
                    Download Living Fit & get started for free.
                  </h2>
                  <p className="mb-10 text-base text-body">
                    The Living Fit app requires iOS version 13+.
                  </p>

                  <div
                    className="-mx-[10px] flex flex-wrap items-center justify-center lg:justify-start"
                  >
                    <div className="inline-block px-[10px]">
                      <a
                        href="https://apps.apple.com/us/app/living-fit-family/id6457937962"
              ...
              <div className="w-full px-4 lg:w-1/2">
                ...
                >
                  ...
                  />
                  <div
                    className="absolute -top-5 left-0 right-0 -z-10 aspect-square w-full rounded-full bg-gradient-2"
                  ></div>

...
const authUserContext = createContext({
    authUser: {},
    loading: true,
    createCheckoutSession: (username: string, uid: string): Promise<void> => Promise.resolve(),
    register: (email: string, password: string): Promise<User | null> => Promise.resolve(defaultUser),
